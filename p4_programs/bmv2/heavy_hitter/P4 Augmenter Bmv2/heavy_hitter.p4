...
action assert_check_fail_1(){
 ...
 action assert_check_pass_1(){
    ...
    const entries = {
    0: assert_check_pass_1();
    3: assert_check_pass_1();
    6: assert_check_pass_1();
...
action assert_check_fail_2(){
 ...
 action assert_check_pass_2(){
    ...
    const entries = {
    3: assert_check_pass_2();
    4: assert_check_pass_2();
    5: assert_check_pass_2();
    6: assert_check_pass_2();
    7: assert_check_pass_2();
