...
action assert_check_fail_1(){
 ...
 action assert_check_pass_1(){
	...
	const entries = {
	0x3: assert_check_pass_1();
	0x5: assert_check_pass_1();
	0x4: assert_check_pass_1();
	
	} 
}

action assert_check_fail_2(){
	meta.assertion_check_2 = 0;
}

 action assert_check_pass_2(){
	meta.assertion_check_2 = 1;
}
	...
	const entries = {
	0x3: assert_check_pass_2();
	0x2: assert_check_pass_2();
	0x1: assert_check_pass_2();
	0x0: assert_check_pass_2();
	0x5: assert_check_pass_2();
	0x4: assert_check_pass_2();
	...
	meta.BL = meta.BL + 6;
		...
		if(meta.assertion_check_1==1 && meta.counter_one>1000 && meta.counter_two>1000){
			assert_check_pass_1();
		}else{
			assert_check_fail_1();
		}
		...
		if(meta.assertion_check_2==1 && hdr.tcp.isValid()){
			assert_check_pass_2();
		}else{
			assert_check_fail_2();
		}
