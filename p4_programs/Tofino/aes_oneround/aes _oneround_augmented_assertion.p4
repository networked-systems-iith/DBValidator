...
action assert_check_fail_1(){
 ...
 action assert_check_pass_1(){
	...
	action NoAction(){
		ig_md.BL = ig_md.BL + 41;
			ig_md.BL = ig_md.BL + 29;
			ig_md.BL = ig_md.BL + 19;
			ig_md.BL = ig_md.BL + 25;
			ig_md.BL = ig_md.BL + 13;
			ig_md.BL = ig_md.BL + 6;
			ig_md.BL = ig_md.BL + 12;
			ig_md.BL = ig_md.BL + 9;
			ig_md.BL = ig_md.BL + 16;
			ig_md.BL = ig_md.BL + 35;
			ig_md.BL = ig_md.BL + 3;
        ...
        apply {
            ...
            tb_lookup_0_0_t.apply();/////// tb_lookup_0_0_t.hit();
