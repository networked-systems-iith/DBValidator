...
def extract_tables(filename):
  ...
  for table in data["tables"]:
    if table["table_type"]=="match" and (cnt_blk+ "Parser") not in table['name'] and "tbl_"+file_name not in table["name"]:
...
def extract_actions(filename):
  ...
  node_to_action =[]
  for table in data["tables"]:
    if table["table_type"]=="match" and (cnt_blk+ ".") in table['name'] and "tbl_"+file_name not in table["name"]:
