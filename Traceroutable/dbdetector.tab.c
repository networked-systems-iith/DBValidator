...
void new_expr_ip(string op1, string ip){
	...
	if(!str_exp.empty()){
		sub_exp = op1 + comp_oper + ip_hex;
	}
	else{
		str_exp = op1 + comp_oper + ip_hex;
	}
...
#line 378 "dbdetector.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 321 "dbdetector.y" /* yacc.c:355  */
...
#line 458 "dbdetector.tab.c" /* yacc.c:355  */
};
...
#line 475 "dbdetector.tab.c" /* yacc.c:358  */
...
{
       0,   356,   356,   356,   359,   360,   363,   364,   366,   367,
     370,   371,   372,   373,   374,   377,   378,   379,   380,   381,
     382,   383,   384,   386,   387,   388,   389,   390,   391,   394,
     395,   396,   397,   398,   399
};
#endif
...
{
     -39,     1,   -39,     3,     9,   -39,    -5,   -39,    31,    31,
      12,    34,    45,    48,   -14,    -3,    -1,    43,   -39,   -39,
     -39,   -39,   -39,   -39,   -39,    11,    21,     2,    60,    48,
     -39,    71,   -39,    30,    30,    48,    48,   -39,   -39,   -39,
      72,   -39,   -39,   -39,   -39,   -39,   -39,    40,    73,     0,
      55,   -39,   -39,   -39,   -39,     6,    72,   -39,    22,    32,
      41,   -39,   -39,   -39,    48,    48,   -39,    79,    81,   -39,
     -39
};
...
{
       2,     0,     1,     0,     0,     3,     0,     5,     0,     0,
       0,    10,     0,     0,     0,     0,     0,     0,     4,    33,
      34,    30,    29,    32,    31,     0,     0,     0,     0,     0,
      28,     0,     9,     0,     0,     0,     0,     8,     7,     6,
      11,    12,    15,    21,    22,    19,    20,     0,     0,     0,
      10,    13,    14,    23,    24,     0,     0,    27,     0,     0,
       0,    16,    17,    18,     0,     0,    11,     0,     0,    25,
      26
};
...
{
      17,     2,    55,    30,    31,    42,    32,    43,    44,    61,
      33,    34,    35,    36,    16,    58,    59,    37,    55,    38,
      48,    10,     8,    33,    34,    41,    53,    54,     9,     3,
       4,    40,    45,    46,    50,    11,    62,    63,    51,    52,
       3,    64,    19,    20,    21,    22,    23,    24,    12,    28,
      13,    65,    28,    25,    18,    67,    68,    26,    35,    36,
      56,    66,    12,    39,    29,    12,     0,    13,    19,    20,
      21,    22,    23,    24,    60,     0,     0,     0,    26,    47,
      19,    20,    21,    22,    23,    24,    35,    36,    35,    36,
       0,    49,     0,    57,    35,    36,    35,    36,     0,    69,
       0,    70
};

static const yytype_int8 yycheck[] =
{
       9,     0,    40,    12,    13,     3,    20,     5,     6,     3,
      24,    25,    15,    16,     9,    15,    16,    20,    56,    20,
      29,    26,    19,    24,    25,     4,    35,    36,    19,    28,
      29,    20,    30,    31,     4,     4,    30,    31,    33,    34,
      28,    19,     8,     9,    10,    11,    12,    13,    17,     4,
      19,    19,     4,    19,    10,    64,    65,    23,    15,    16,
      20,    20,    17,    20,    19,    17,    -1,    19,     8,     9,
      10,    11,    12,    13,    19,    -1,    -1,    -1,    23,    19,
       8,     9,    10,    11,    12,    13,    15,    16,    15,    16,
      -1,    20,    -1,    20,    15,    16,    15,    16,    -1,    20,
      -1,    20
};
...
static const yytype_uint8 yystos[] =
{
      ...
      26,     4,    17,    19,    37,    38,    37,    38,    36,     8,
       9,    10,    11,    12,    13,    19,    23,    39,     4,    19,
      38,    38,    20,    24,    25,    15,    16,    20,    20,    20,
      20,     4,     3,     5,     6,    30,    31,    19,    38,    20,
       4,    37,    37,    38,    38,    39,    20,    20,    15,    16,
      19,     3,    30,    31,    19,    19,    20,    38,    38,    20,
      20
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 356 "dbdetector.y" /* yacc.c:1646  */
    {printf("\nDone-parsing...!!!\n"); create_p4_table_definition(); assertion_count_up(); }
#line 1599 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 359 "dbdetector.y" /* yacc.c:1646  */
    {}
#line 1605 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 360 "dbdetector.y" /* yacc.c:1646  */
    {}
#line 1611 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 363 "dbdetector.y" /* yacc.c:1646  */
    {new_filter_exp();}
#line 1617 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 364 "dbdetector.y" /* yacc.c:1646  */
    {add_action_definition(); new_filter_path();table_count_up(); }
#line 1623 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 366 "dbdetector.y" /* yacc.c:1646  */
    {new_match_exp(); }
#line 1629 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 367 "dbdetector.y" /* yacc.c:1646  */
    {add_action_definition(); new_match_path(); table_count_up(); }
#line 1635 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 370 "dbdetector.y" /* yacc.c:1646  */
    {identify_path((yyvsp[0].sval)); cout<<"\n\tSTRING\t";}
#line 1641 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 371 "dbdetector.y" /* yacc.c:1646  */
    {identify_fun_path((yyvsp[-2].sval));}
#line 1647 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 372 "dbdetector.y" /* yacc.c:1646  */
    {identify_path((yyvsp[-2].sval),"@",(yyvsp[0].sval)); cout<<"\n\tAT\t";}
#line 1653 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 373 "dbdetector.y" /* yacc.c:1646  */
    {add_any(); cout<<"\n\tANY\t";}
#line 1659 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 374 "dbdetector.y" /* yacc.c:1646  */
    {add_concat(); cout<<"\n\tCONCAT\t";}
#line 1665 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 377 "dbdetector.y" /* yacc.c:1646  */
    {new_expr((yyvsp[-2].sval), (yyvsp[0].ival)); }
#line 1671 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 378 "dbdetector.y" /* yacc.c:1646  */
    {new_fun_expr((yyvsp[-4].sval), (yyvsp[0].ival));}
#line 1677 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 379 "dbdetector.y" /* yacc.c:1646  */
    {new_fun_expr((yyvsp[-4].sval), "(bool)1");}
#line 1683 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 380 "dbdetector.y" /* yacc.c:1646  */
    {new_fun_expr((yyvsp[-4].sval), "(bool)0");}
#line 1689 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 381 "dbdetector.y" /* yacc.c:1646  */
    { new_expr((yyvsp[-2].sval), "(bool)1"); }
#line 1695 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 382 "dbdetector.y" /* yacc.c:1646  */
    { new_expr((yyvsp[-2].sval), "(bool)0"); }
#line 1701 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 383 "dbdetector.y" /* yacc.c:1646  */
    { new_expr((yyvsp[-2].sval), (yyvsp[0].hexval)); }
#line 1707 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 384 "dbdetector.y" /* yacc.c:1646  */
    {new_expr_ip((yyvsp[-2].sval), (yyvsp[0].ipaddrval)); }
#line 1713 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 386 "dbdetector.y" /* yacc.c:1646  */
    {identify_log_opr(" || "); }
#line 1719 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 387 "dbdetector.y" /* yacc.c:1646  */
    {identify_log_opr(" && "); }
#line 1725 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 29:
#line 394 "dbdetector.y" /* yacc.c:1646  */
    {identify_comp_opr((char *)">"); }
#line 1731 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 395 "dbdetector.y" /* yacc.c:1646  */
    {identify_comp_opr("<"); }
#line 1737 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 396 "dbdetector.y" /* yacc.c:1646  */
    {identify_comp_opr(">="); }
#line 1743 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 32:
#line 397 "dbdetector.y" /* yacc.c:1646  */
    {identify_comp_opr("<="); }
#line 1749 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 33:
#line 398 "dbdetector.y" /* yacc.c:1646  */
    {identify_comp_opr((char *)"=="); }
#line 1755 "dbdetector.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 399 "dbdetector.y" /* yacc.c:1646  */
    {identify_comp_opr("!="); }
#line 1761 "dbdetector.tab.c" /* yacc.c:1646  */
    break;


#line 1765 "dbdetector.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 402 "dbdetector.y" /* yacc.c:1906  */
